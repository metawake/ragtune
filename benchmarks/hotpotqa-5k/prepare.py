#!/usr/bin/env python3
"""
Prepare HotpotQA benchmark dataset for RagTune - 5K DOCUMENTS version.

Downloads HotpotQA from HuggingFace and extracts:
- 5,000 unique Wikipedia paragraphs (docs)
...
def main():
    ...
    target_docs = 5000  # Target: 5,000 unique documents
...
To run the benchmark:
  ragtune ingest ./benchmarks/hotpotqa-5k/docs --collection hotpotqa-5k
  ragtune simulate --collection hotpotqa-5k --queries ./benchmarks/hotpotqa-5k/queries.json
""")
